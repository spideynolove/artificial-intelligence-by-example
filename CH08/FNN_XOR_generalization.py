import random
# FEEDFORWARD NEURAL NETWORK(FNN)FOR XOR APPLIED TO AN OPTIMIZING EXAMPLE
...
for element in range(1000000):
    ...
    if (result[0] > 0):
        subsets += 1
        print("Subset:", subsets, "size subset #", x1, " and ", "size subset #",
              x2, " result:", result[0], "order #", " and ", s1, "order #", s2)
    if (subsets >= 8333):
        break
    result[0] = 0
