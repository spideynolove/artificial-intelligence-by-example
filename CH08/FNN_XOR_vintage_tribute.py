...
for epoch in range(50):
    ...
    print("epoch:", epoch, "optimization", round(train-sum(result)), "w1:", round(w1, 4), "w2:",
          round(w2, 4), "w3:", round(w3, 4), "w4:", round(w4, 4), "b1:", round(-b1, 4), "b2:", round(b2, 4))
    ...
    if (convergence < 0):
        w2 += training_step
        b1 = w2    # a simple step increasing value based on the estimator of convergence
    result[0] = 0
    result[1] = 0
    result[2] = 0
    result[3] = 0
